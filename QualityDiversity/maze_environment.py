...
def maze_simulation_evaluate(env, net, time_steps, mcns=0.0, item=None, path_points=None, headings=None):
    """
    ...
    Arguments:
        ...
        headings:       The holder for heading angles of agent.
    Returns:
